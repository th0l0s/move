...
const LINES = [
  {
    ...
    rami: [
      { stops: ["canonica", "fara"], label: "deviazione per Fara Gera d'Adda, pochissime corse in tutti e due i versi" },
      { stops: ["treviglio", "badalasco", "fara"], label: "giro di Badalasco e Fara, quasi solo corse scolastiche" },
      { stops: ["fara", "cassano"], label: "prosecuzione per Cassano d'Adda, quasi solo corse scolastiche" },
      { stops: ["treviglio", "colonnella", "cassano"], label: "rientro da Cassano per il Bivio Colonnella" },
    ],
    rotte: [
      { dir: "verso Trezzo", stops: ["treviglio", "geromina", "castelcerreto", "pontirolo", "canonica", "vaprio", "trezzo"] },
      { dir: "verso Treviglio", stops: ["trezzo", "vaprio", "canonica", "pontirolo", "castelcerreto", "geromina", "treviglio"] },
      { dir: "deviazione per Fara verso Trezzo", limitata: true, stops: ["treviglio", "geromina", "castelcerreto", "pontirolo", "canonica", "fara", "canonica", "vaprio", "trezzo"] },
      { dir: "deviazione per Fara verso Treviglio", limitata: true, stops: ["trezzo", "vaprio", "canonica", "fara", "canonica", "pontirolo", "castelcerreto", "geromina", "treviglio"] },
      { dir: "giro di Fara e Cassano", limitata: true, stops: ["treviglio", "badalasco", "fara", "cassano", "badalasco", "treviglio"] },
      { dir: "giro di Cassano e Fara", limitata: true, stops: ["treviglio", "cassano", "colonnella", "treviglio", "badalasco", "fara", "treviglio"] },
    ],
    validita: "Libretto in vigore dal 14/09/2026",
    giorni: "Lun–Sab (nessuna corsa festiva)",
    sabato: true, festivi: false,
    note: "La dorsale passa da Pontirolo e Canonica, non da Fara Gera d'Adda: dentro Fara entrano una corsa verso Trezzo e cinque verso Treviglio. Il resto del servizio su Fara è il giro Treviglio–Badalasco–Fara–Cassano, dodici corse per verso ma quasi tutte scolastiche. Per muoverti da Fara tutti i giorni la linea è la B812.",
  },
  {
    id: "b812",
    code: "B812",
